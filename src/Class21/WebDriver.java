...
public class WebDriver {
    ...
    class GoogleChrome extends WebDriver {
        ...
        void clickSubmit() {
            System.out.println("clicking on the submit button in Google Chrome ");
        }
        ...
        class FireFox extends WebDriver {
            ...
            void clickSubmit() {
                System.out.println("clicking on the submit button in FireFox");
            }
            ...
            class Safari extends WebDriver{
                ...
                void clickSubmit(){
                    System.out.println("clicking on the submit button in Safari");
                }
                void closeBrowser(){
